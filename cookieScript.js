  ...
  function createPlaceholder(originalScript, category = "uncategorized") {
    try {
        ...
        if (originalScript.src) {
            ...
            placeholder.setAttribute("data-original-content-hash", 
                originalScript.textContent.length.toString()); // Basic reference
        }
        ...
        // Add script info to our map using the ID as key
  ...
  function blockAllInitialRequests() {
    ...
    window.XMLHttpRequest = function() {
        ...
        xhr.open = function(method, url, ...args) {
            ...
            // Always call original open to maintain proper XHR state
        ...
        xhr.send = function(...args) {
            if (initialBlockingEnabled && isSuspiciousResource(this._consentBitUrl)) {
                ...
                // Simulate a completed request instead of breaking it
                setTimeout(() => {
