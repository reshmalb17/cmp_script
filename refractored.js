...
function setConsentState(preferences) {
  setConsentCookie('cb-consent-analytics_storage', preferences.analytics ? 'true' : 'false', 365);
  setConsentCookie('cb-consent-marketing_storage', preferences.marketing ? 'true' : 'false', 365);
  setConsentCookie('cb-consent-personalization_storage', preferences.personalization ? 'true' : 'false', 365);
